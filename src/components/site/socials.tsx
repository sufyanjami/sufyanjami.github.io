...
function SocialItem({
  ...
  return (
    <CodeLink
      ...
      className="border-border bg-card/70 text-muted-foreground hover:text-brand hover:border-brand inline-flex items-center gap-2 rounded-sm border px-3 py-2 font-mono text-xs backdrop-blur-sm transition-colors"
    >
